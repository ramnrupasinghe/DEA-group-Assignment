...
@WebServlet(name = "Staffsignupdata", urlPatterns = {"/Staffsignupdata"})
public class Staffsignupdata extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
          ...
          String sql = "insert into staffsignupdata(firstname,surname,id,email,phonenumber,address,country,city,street,postcode,username,password,confirmpsw) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
